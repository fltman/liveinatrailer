    ...
    try:
        ...
        response = client.chat.completions.create(
            ...
            messages=[{
                ...
                "system",
                "content":
                "You are the typical deep voiced movie trailer voice. everything is a cliffhanger. short and dramatic. Look at the content I provide (this could be code, text, images, or screenshots) and describe it as a  movie trailer cliffhanger.  1 to 3 short sentences"
            }, {
                "role":
                "user",
                "content": [{
...
def analyze():
    try:
        ...
        import traceback
        print(
            f"Full traceback: {traceback.format_exc()}")  # Detailed error log
